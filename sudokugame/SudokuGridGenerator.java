...
public class SudokuGridGenerator
{
   ...
   public static int[][] grid1=new int[9][9];
   ...
   public int[] generate(){
       ...
       while (true) {
           ...
           // not including time it takes for print statements, which eats up BUTT-LOADS of
           // time and slows down the output 10-fold
           if (isPerfect(sudoku.generateGrid()) && count==0) {
               count++;
               return grid;
